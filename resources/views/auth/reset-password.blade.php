            ...
            <div class="reset-form-container">
                ...
                <div class="reset-form">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <md-outlined-text-field label="Email" type="email" name="email" value="{{ old('email', $email) }}" required></md-outlined-text-field>

                        <md-outlined-text-field label="Password" type="password" name="password" required></md-outlined-text-field>

                        <md-outlined-text-field label="Confirm Password" type="password" name="password_confirmation" required></md-outlined-text-field>

                        <md-filled-button class="button" type="submit">Reset Password</md-filled-button>
                    </form>
                </div>
            </div>
        </div>
